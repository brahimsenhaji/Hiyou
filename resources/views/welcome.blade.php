                            ...
                            <div class="col-sm-8 col-lg-6 col-xl-6">
                                ...
                                <div class="py-md-5 py-4">
                                    ...
                                    <div class="text-center mb-5">
                                        <h3>Welcome Back !</h3>
                                        <p class="text-muted">Sign in to continue to Hiyou.</p>
                                        <p style="color: red; font-size:16px">@error('username') {{ $message }} @enderror</p>
                                    </div>
                                    ...
                                    <div class="mt-5 text-center text-muted">
                                        <p>Don't have an account ? <a href="{{route('singup_page')}}"
